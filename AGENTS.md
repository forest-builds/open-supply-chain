...
This project is indexed by GitNexus as **open-supply-chain** (1112 symbols, 2258 relationships, 75 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
