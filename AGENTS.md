...
This project is indexed by GitNexus as **open-supply-chain** (1628 symbols, 3511 relationships, 122 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
